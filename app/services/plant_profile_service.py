...
{{
  ...
  "treatment_guide": {{
    ...
    "biological_controls": ["конкретні біологічні препарати/діючі організми: спочатку діюча основа, потім 1-3 популярні приклади торгових назв, якщо вони типові для України"],
    "chemical_controls": ["конкретні хімічні діючі речовини/групи: спочатку діюча речовина або FRAC/IRAC-група, потім 1-3 популярні приклади торгових назв, якщо вони типові для України"],
...
- treatment_guide має бути загальним практичним довідником по культурі: профілактика, біологічні засоби, хімічні засоби, мідьвмісні обмеження, органічні методи, safety notes.
- У biological_controls і chemical_controls розділяй рекомендації явно: біологічні окремо, хімічні окремо.
- Давай конкретику, корисну для дачника: діюча речовина/організм + приклади 1-3 найпоширеніших торгових назв, якщо вони добре відомі для України/помірного клімату. Формат прикладу: "Bacillus subtilis / Bacillus amyloliquefaciens — Фітоспорин, Серенада/Serenade або аналоги".
- Якщо не впевнений у торговій назві або її реєстрації, не вигадуй; пиши "аналоги за діючою речовиною" і пояснюй, що потрібно звірити етикетку.
- Для хімічних препаратів обов'язково вказуй діючу речовину або клас: мідь, манкоцеб, фосетил-Al/фосфіти, металаксил-М/мефеноксам, азоксистробін, дифеноконазол, сірка, спіносад, піретроїди, авермектини тощо — тільки якщо доречно для культури/проблеми.
- У treatment для КОЖНОЇ конкретної хвороби давай рішення саме проти цієї хвороби: біологічні варіанти окремо, хімічні окремо, з діючою речовиною/прикладами. Не додавай інсектициди в treatment хвороб.
- У treatment для КОЖНОГО конкретного шкідника давай рішення саме проти цього шкідника: механічні/IPM, біологічні інсектициди/ентомофаги, хімічні інсектициди/акарициди окремо. Не додавай фунгіциди в treatment шкідників.
- Не радь препарат, якщо він може бути фітотоксичним або не типовий для цієї культури. Для яблуні, груші, черешні, персика, абрикоса та інших плодових дерев НЕ рекомендуй Квадріс/Quadris або азоксистробін як типовий варіант; обирай безпечніші зареєстровані альтернативи за етикеткою.
- У safety_notes завжди додавай: "перед купівлею/внесенням перевірити етикетку, культуру, шкідника/хворобу, норму, строк очікування і чинну реєстрацію препарату у вашій країні".
...
КРИТИЧНО ПРО PHYTOPHTHORA / "ФІТОФТОРОЗ":
- Не ототожнюй "фітофтороз" у всіх культур. Для томата/картоплі це переважно листкова/плодова хвороба late blight, а для яблуні, груші та інших плодових дерев Phytophthora зазвичай означає гниль кореневої шийки, підщепи або коренів.
- Якщо культура — яблуня/груша/зерняткова/плодове дерево і є Phytophthora, у common_diseases називай її "фітофторозна гниль кореневої шийки/коренів", type="oomycete", likelihood залежно від культури і дренажу.
- Для плодових дерев у symptoms/risk_conditions/treatment обов'язково включай: пожовтіння і дрібнішання листя, слабкий ріст, всихання гілок, темну/буро-фіолетову кору біля кореневої шийки, застій води, важкі ґрунти, заглиблену кореневу шийку.
- Для плодових дерев лікування Phytophthora має починатися з агротехніки: відгребти ґрунт від кореневої шийки на 10-15 см, підсушити, поліпшити дренаж, не поливати під стовбур, мульчу тримати з відступом.
- Для плодових дерев chemical_controls проти Phytophthora пиши як діючі речовини/класи з обережними прикладами: фосетил-Al, фосфіти/фосфонати, мефеноксам/металаксил-М лише якщо дозволено етикеткою для плодових/зерняткових і Phytophthora/collar rot/root rot.
- Для Phytophthora кореневої шийки плодових НЕ радь як основне рішення мідь, бордоську суміш, Хорус/Скор/Топаз або "фунгіцид від парші"; пояснюй, що вони можуть бути для інших хвороб яблуні, але не вирішують кореневу Phytophthora без дренажу.
"""
