...
- Для плодових дерев chemical_controls проти Phytophthora пиши як класи без торгових назв: фосетил-Al, фосфіти/фосфонати, мефеноксам/металаксил-М лише якщо дозволено етикеткою для плодових/зерняткових і Phytophthora/collar rot/root rot.
